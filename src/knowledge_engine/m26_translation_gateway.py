...
TRANSLATION_GATEWAY_STATUS_READY = (
    "IMPLEMENTATION_CANDIDATE_READY_FOR_INDEPENDENT_HELDOUT_QUALIFICATION"
)
FAILURE_CODES = {
    ...
    *,
    ...
    if detected == "en":
        if progress_callback is not None:
            progress_callback("stage_started", {"stage": "translation_in", "role": "translation"})
        ...
        if progress_callback is not None:
            progress_callback("stage_completed", {"stage": "translation_in", "role": "translation"})
    ...
    if progress_callback is not None:
        progress_callback(
            "stage_started",
            {"stage": "translation_in", "role": "translation", "detected_language": detected},
        )
    ...
    if progress_callback is not None:
        progress_callback(
            "stage_completed",
            {
                ...
                "role": "translation",
                "provider": observability.get("provider", ""),
            },
        )
