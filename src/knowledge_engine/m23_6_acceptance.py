...
EXPECTED_CHAINS = (
    {
        "milestone": "M23.6.1",
        "issue": 384,
        "implementation_pr": 385,
        "reconciliation_pr": 386,
        "entry_base": "e6557ff8b3f6eb8ce7cd206df5bf0a4794ae34fb",
        "implementation_head": "2a284811d36128ec44a16c694930e620b7ee485d",
        "implementation_merge": "620d0dba184d5bbda7e32a86fb7fb388017778fc",
        "reconciliation_head": "832565fc6de72286c6c0d6c26a8707c26a0e62c8",
        "reconciliation_merge": "913c8cbb19dd6c7b89b753aecd61afd943e373fc",
        "workflows": (
    ...
    },
    {
        ...
        "reconciliation_pr": 389,
        "entry_base": "913c8cbb19dd6c7b89b753aecd61afd943e373fc",
        "implementation_head": "f9de0b5d7b351b2551f9cf68a36a31f5674acbfa",
        "implementation_merge": "f9c17811bc23f7af171686805c9c93e0ca7c78bd",
        "reconciliation_head": "4a4bc3dc451566a33236a16e1d0de593fc7661b9",
        "reconciliation_merge": "8fd1e00632aebb2ab5af487fbcd626e9f8f3305f",
        "workflows": (
    ...
    },
    {
        "milestone": "M23.6.2a",
        "issue": 390,
        "implementation_pr": 391,
        "reconciliation_pr": 392,
        "entry_base": "8fd1e00632aebb2ab5af487fbcd626e9f8f3305f",
        "implementation_head": "78cc20e1c076ce388a80553b0162f178a27d90bb",
        "implementation_merge": "067e5d70c8204d0976a917ef0ff2b2b9a0e8d932",
        "reconciliation_head": "f19834c23878514aafc8f5e88e4a9ab04c102703",
        "reconciliation_merge": "43b6f2b0dd39ae0e7a19fbcce81272071a279dcf",
        "workflows": (
    ...
    },
    {
        "milestone": "M23.6.3",
        "issue": 393,
        "implementation_pr": 394,
        "reconciliation_pr": 395,
        "entry_base": "43b6f2b0dd39ae0e7a19fbcce81272071a279dcf",
        "implementation_head": "ae9dee012b0dcd12f4844c995a6b71cb5c2e5754",
        "implementation_merge": "152f8b41b4dc5aedd7e96b77a86a0ea6d60e93ab",
        "reconciliation_head": "4f7ef218e5eaf9ba2f01edccbe18e91d86c5b578",
        "reconciliation_merge": "baa0fb9bf89bb216dbc34d3fb633b6eee706f029",
        "workflows": (
    ...
    },
    {
        "milestone": "M23.6.4",
        "issue": 396,
        "implementation_pr": 397,
        "reconciliation_pr": 398,
        "entry_base": "baa0fb9bf89bb216dbc34d3fb633b6eee706f029",
        "implementation_head": "2a5ce95d105484a77df5e5d7151c2c5e7238cd7d",
        "implementation_merge": "343bd53057868536b47179b97b32008e60ef00e3",
        "reconciliation_head": "2b398db89d8bfbbc713681932fd7923778427c9c",
        "reconciliation_merge": "d0fb8b1b799d91b15520fd0bf8dacd093cf91e0d",
        "workflows": (
    ...
    },
    {
        "milestone": "M23.6.5",
        "issue": 399,
        "implementation_pr": 400,
        "reconciliation_pr": 401,
        "entry_base": "d0fb8b1b799d91b15520fd0bf8dacd093cf91e0d",
        "implementation_head": "26344362436f69c041723885aced788e5de007e3",
        "implementation_merge": "daafeb7d0a295e1434e1487dc2b5e0ab1e5bad24",
        "reconciliation_head": "f1aa162d916199b1add01bbc39bac11882787e8f",
        "reconciliation_merge": "0eecc89bb711e7df8976a79d46bcd2d1072be44a",
        "workflows": (
    ...
    },
    {
        "milestone": "M23.6.6",
        "issue": 402,
        "implementation_pr": 403,
        "reconciliation_pr": 404,
        "entry_base": "0eecc89bb711e7df8976a79d46bcd2d1072be44a",
        "implementation_head": "2a5a9ea181d0ed35f9e46b89139e2d2103b96804",
        "implementation_merge": "22cc6c51dac5c21251ed6350b40c94e452143e10",
        "reconciliation_head": "3e53ad6dd6c2ba6b79dfc56c72ab3377e8dd5ce9",
...
def _exact_mapping(value: Any, expected: Mapping[str, Any], label: str) -> dict[str, Any]:
...
def _validate_workflows(value: Any, expected: Mapping[str, Any]) -> list[dict[str, Any]]:
    ...
    for actual, required in zip(rows, wanted, strict=True):
        ...
        if set(item) != {"name", "run_number", "run_id", "head_sha", "conclusion"}:
    ...
    identities = {(item["name"], item["run_number"], item["run_id"]) for item in normalized}
...
def validate_m23_6_acceptance(payload: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if [row["milestone"] for row in normalized] != [
        "M23.6.1",
        "M23.6.2",
        "M23.6.2a",
        "M23.6.3",
...
def build_m23_6_acceptance_report(payload: Mapping[str, Any]) -> dict[str, Any]:
    ...
    evidence_digest = _sha(normalized)
    return {
