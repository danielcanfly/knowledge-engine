...
from scripts import m23_7_r3_8_remote_recovery_probe_296468 as adapter


def test_adapter_declares_only_exact_authorized_identity_without_import_mutation() -> None:
    assert adapter.AUTHORIZED_RUN_ID == "29646853002"
    assert adapter.AUTHORIZED_ENGINE_SHA == (
        "a5fca48683567b48a196e67657bd7dc4a4b9c554"
    )
    assert adapter.AUTHORIZED_WORKER_NAME == "knowledge-engine-r3-8-29646853002"
