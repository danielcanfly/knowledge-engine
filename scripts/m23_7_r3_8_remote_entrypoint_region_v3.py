...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Bounded R3.8 region-placement-v3 remote entrypoint"
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    entry = {
        ...
        "region_contract_sha256": REGION_CONTRACT_SHA256,
        "placement_target_type": "region",
        "placement_region_persisted": False,
    ...
    try:
        from scripts import m23_7_r3_8_remote_operator_region_v3 as operator
        ...
        failure = {
            ...
            "failure_stage": "remote_entrypoint_region_v3",
            "github_run_id": args.run_id,
            "github_run_attempt": args.run_attempt,
            "expected_head": args.expected_head,
            "actual_head": actual_head,
