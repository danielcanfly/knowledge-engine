...
ENTRY_SCHEMA = "knowledge-engine-m23-7-r3-8-remote-entrypoint-placement-v2/v1"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Bounded R3.8 placement-semantics-v2 remote entrypoint"
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        from scripts import m23_7_r3_8_remote_operator_placement_v2 as operator
        ...
        failure = {
            ...
            "failure_stage": "remote_entrypoint_placement_v2",
            "github_run_id": args.run_id,
            "github_run_attempt": args.run_attempt,
            "expected_head": args.expected_head,
            "actual_head": actual_head,
