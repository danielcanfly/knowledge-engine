...
probe for retained diagnostic worker `knowledge-engine-r3-8-29610393567`.

Deletion authorization merged in PR #882 at
`18c368467732c4432d800a169db9924a69abbf35`, binding authorization digest
`9c397501ef57dc7e925c5a8a125fe6881c3ef47657df5d5846d47b6f004e5f16`.

Remote-delete run `29612072321` dispatched the Worker delete and then failed
...
`ab89c76649db466d6e0b306734dfe806ae93adf01bf7229fa9ed5bded19c893e`.

Post-delete recovery probe run `29612149139` then performed read-only
...
self-digest is `f1242b29bb7b0c2d61df2b238e34240292d7e20a50c370b5ae359ffb64f57a6b`.
